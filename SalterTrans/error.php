	...
	<main role="main">
		<section class="medium-bg">
			<div class="page-wrapper">
				<h1>Oops! Something went wrong. Please try again.</h1><br />
				
				<a href="contact.html"><h2>Return to the contact form </h2> <br /> </a>
				<img src="images/stop.jpg" alt="School bus stop sign expanded." />
			</div>
		<section>
	</main>
<footer>
